...
const LeftMenu = ({ isFullPage = false }: { isFullPage?: boolean }) => {
  ...
  const collectionTypeLinks = useTypedSelector(
    (state) => state['custom-content-manager2'].app.collectionTypeLinks
  );

  const singleTypeLinks = useTypedSelector((state) => state['custom-content-manager2'].app.singleTypeLinks);
