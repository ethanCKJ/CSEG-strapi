...
const ALL_PERMISSIONS = [
  {
    id: 183,
    action: 'plugin::custom-content-manager2.explorer.delete',
    actionParameters: {},
  ...
  {
    id: 194,
    action: 'plugin::custom-content-manager2.explorer.publish',
    actionParameters: {},
    subject: 'api::address.address',
    properties: {},
    conditions: [],
  ...
  {
    id: 666,
    action: 'plugin::custom-content-manager2.explorer.create',
    actionParameters: {},
    subject: 'api::address.address',
    properties: {
      fields: [
  ...
  {
    id: 667,
    action: 'plugin::custom-content-manager2.explorer.read',
    actionParameters: {},
    subject: 'api::address.address',
    properties: {
      fields: [
  ...
  {
    id: 668,
    action: 'plugin::custom-content-manager2.explorer.update',
    actionParameters: {},
    subject: 'api::address.address',
    properties: {
      fields: [
  ...
  renderRTLHook(() => useDocumentRBAC('TEST', (state) => state), {
    wrapper({ children }) {
      return (
        <Routes>
          <Route
            path="/custom-content-manager2/:collectionType/:slug"
            element={<DocumentRBAC permissions={permissions}>{children}</DocumentRBAC>}
          />
        </Routes>
      );
    },
    initialEntries: ['/custom-content-manager2/collection-type/api::address.address'],
  });
