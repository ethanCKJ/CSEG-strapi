  ...
  endpoints: (builder) => ({
    ...
    >({
      query: ({ model, sourceId, params }) => ({
        url: `/custom-content-manager2/collection-types/${model}/auto-clone/${sourceId}`,
        method: 'POST',
        config: {
          params,
        },
    ...
    >({
      query: ({ model, sourceId, data, params }) => ({
        url: `/custom-content-manager2/collection-types/${model}/clone/${sourceId}`,
        method: 'POST',
        data,
        config: {
          params,
    ...
    >({
      query: ({ model, data, params }) => ({
        url: `/custom-content-manager2/collection-types/${model}`,
        method: 'POST',
        data,
        config: {
          params,
    ...
    >({
      query: ({ collectionType, model, documentId, params }) => ({
        url: `/custom-content-manager2/${collectionType}/${model}${
    ...
    >({
      query: ({ model, params, ...body }) => ({
        url: `/custom-content-manager2/collection-types/${model}/actions/bulkDelete`,
        method: 'POST',
        data: body,
        config: {
          params,
    ...
    >({
      query: ({ collectionType, model, documentId, params }) => ({
        url: documentId
          ? `/custom-content-manager2/${collectionType}/${model}/${documentId}/actions/discard`
          : `/custom-content-manager2/${collectionType}/${model}/actions/discard`,
        method: 'POST',
        config: {
          params,
        },
    ...
    >({
      query: ({ collectionType, model, documentId, params }) => ({
        url: documentId
          ? `/custom-content-manager2/${collectionType}/${model}/${documentId}/actions/countDraftRelations`
          : `/custom-content-manager2/${collectionType}/${model}/actions/countDraftRelations`,
        method: 'GET',
        config: {
          params,
        },
    ...
    >({
      ...
      queryFn: async (
        ...
        const res = await baseQuery({
          url: `/custom-content-manager2/${collectionType}/${model}${documentId ? `/${documentId}` : ''}`,
          method: 'GET',
          config: {
            params,
          },
    ...
    >({
      query: ({ model, ...params }) => ({
        url: `/custom-content-manager2/collection-types/${model}/actions/countManyEntriesDraftRelations`,
        method: 'GET',
        config: {
          params,
        },
    ...
    >({
      query: ({ collectionType, model, documentId, params, data }) => ({
        url: documentId
          ? `/custom-content-manager2/${collectionType}/${model}/${documentId}/actions/publish`
          : `/custom-content-manager2/${collectionType}/${model}/actions/publish`,
        method: 'POST',
        data,
        config: {
          params,
    ...
    >({
      query: ({ model, params, ...body }) => ({
        url: `/custom-content-manager2/collection-types/${model}/actions/bulkPublish`,
        method: 'POST',
        data: body,
        config: {
          params,
    ...
    >({
      query: ({ collectionType, model, documentId, params, data }) => ({
        url: documentId
          ? `/custom-content-manager2/${collectionType}/${model}/${documentId}/actions/unpublish`
          : `/custom-content-manager2/${collectionType}/${model}/actions/unpublish`,
        method: 'POST',
        data,
        config: {
          params,
    ...
    >({
      query: ({ model, params, ...body }) => ({
        url: `/custom-content-manager2/collection-types/${model}/actions/bulkUnpublish`,
        method: 'POST',
        data: body,
        config: {
          params,
