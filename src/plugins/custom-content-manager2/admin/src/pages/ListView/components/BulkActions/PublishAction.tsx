...
import type { BulkActionComponent } from '../../../../custom-content-manager2';
    ...
    return (
      <Flex gap={2}>
        ...
        <Typography textColor="success600" fontWeight="bold">
          {formatMessage({
            id: 'custom-content-manager2.bulk-publish.already-published',
    ...
    return (
      <Flex gap={2}>
        ...
        <Typography textColor="alternative600" fontWeight="bold">
          {formatMessage({
            id: 'custom-content-manager2.bulk-publish.modified',
            ...
            <Table.Cell>
              {isPublishing && entriesToPublish.includes(row.documentId) ? (
                <Flex gap={2}>
                  <Typography>
                    {formatMessage({
                      id: 'custom-content-manager2.success.record.publishing',
            ...
            <Table.Cell>
              <Flex>
                <IconButton
                  ...
                  state={{ from: pathname }}
                  label={formatMessage({
                    id: 'custom-content-manager2.bulk-publish.edit',
                    defaultMessage: 'Edit',
                  })}
                  target="_blank"
                  marginLeft="auto"
          ...
          <Tr>
            ...
            <Td>
              <PublicationStatusSummary
                ...
                message={formatMessage({
                  id: 'custom-content-manager2.bulk-publish.waiting-for-action',
