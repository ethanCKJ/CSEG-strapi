...
const TableActions = ({ document }: TableActionsProps) => {
  ...
  return (
    <DescriptionComponentRenderer
      props={props}
      descriptions={(plugins['custom-content-manager2'].apis as ContentManagerPlugin['config']['apis'])
      ...
      {(actions) => {
        ...
        return (
          <DocumentActionsMenu
            ...
            label={formatMessage({
              id: 'custom-content-manager2.containers.list.table.row-actions',
      ...
      if (!documentId) {
        ...
        toggleNotification({
          message: formatMessage({
            id: 'custom-content-manager2.actions.edit.error',
...
const CloneAction: DocumentActionComponent = ({ model, documentId }) => {
  ...
  return {
    ...
    label: formatMessage({
      id: 'custom-content-manager2.actions.clone.label',
    ...
    onClick: async () => {
      if (!documentId) {
        ...
        toggleNotification({
          message: formatMessage({
            id: 'custom-content-manager2.actions.clone.error',
    ...
    dialog: {
      type: 'modal',
      title: formatMessage({
        id: 'custom-content-manager2.containers.list.autoCloneModal.header',
        defaultMessage: 'Duplicate',
      }),
      ...
      footer: ({ onClose }) => {
        return (
          <Modal.Footer>
            ...
            >
              {formatMessage({
                id: 'custom-content-manager2.containers.list.autoCloneModal.create',
