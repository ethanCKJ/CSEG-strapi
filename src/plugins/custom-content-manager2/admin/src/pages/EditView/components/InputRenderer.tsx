 ...
 * specifically to be used in the EditView of the custom-content-manager2 this understands
...
const BaseInputRenderer = ({
  ...
  /**
   * These include the custom-content-manager2 specific fields, failing that we fall back
...
const useFieldHint = (
  ...
  const units = ['string', 'uid', 'richtext', 'email', 'password', 'text'].includes(attribute.type)
    ? formatMessage(
        {
          id: 'custom-content-manager2.form.Input.hint.character.unit',
  ...
  return formatMessage(
    {
      id: 'custom-content-manager2.form.Input.hint.text',
      defaultMessage:
    ...
    },
    {
      ...
      divider: hasMinAndMax
        ? formatMessage({
            id: 'custom-content-manager2.form.Input.hint.minMaxDivider',
            defaultMessage: ' / ',
          })
        : null,
      br: <br />,
