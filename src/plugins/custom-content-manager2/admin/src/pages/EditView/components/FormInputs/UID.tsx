                  ...
                  >
                    {formatMessage(
                      availability.isAvailable
                        ? {
                            id: 'custom-content-manager2.components.uid.available',
                            defaultMessage: 'Available',
                          }
                        : {
                            id: 'custom-content-manager2.components.uid.unavailable',
                  ...
                  {showRegenerate && (
                    <TextValidation alignItems="center" justifyContent="flex-end" gap={1}>
                      <Typography textColor="primary600" variant="pi">
                        {formatMessage({
                          id: 'custom-content-manager2.components.uid.regenerate',
