...
import type { ContentManagerPlugin, DocumentActionComponent } from '../../../custom-content-manager2';
...
const Header = ({ isCreating, status, title: documentTitle = 'Untitled' }: HeaderProps) => {
  ...
  const title = isCreating
    ? formatMessage({
        id: 'custom-content-manager2.containers.edit.title.new',
  ...
  return (
    <Flex gap={2}>
      <DescriptionComponentRenderer
        ...
        descriptions={(
          plugins['custom-content-manager2'].apis as ContentManagerPlugin['config']['apis']
        ).getHeaderActions()}
      >
        {(actions) => {
          if (actions.length > 0) {
        ...
        {(actions) => {
          ...
          return (
            <DocumentActionsMenu
              ...
              label={formatMessage({
                id: 'custom-content-manager2.containers.edit.header.more-actions',
  ...
  const information: Array<{ isDisplayed?: boolean; label: string; value: React.ReactNode }> = [
    {
      ...
      label: formatMessage({
        id: 'custom-content-manager2.containers.edit.information.last-published.label',
        defaultMessage: 'Published',
      }),
      value: formatMessage(
        {
          id: 'custom-content-manager2.containers.edit.information.last-published.value',
    ...
    },
    {
      ...
      label: formatMessage({
        id: 'custom-content-manager2.containers.edit.information.last-draft.label',
        defaultMessage: 'Updated',
      }),
      value: formatMessage(
        {
          id: 'custom-content-manager2.containers.edit.information.last-draft.value',
          defaultMessage: `{time}{isAnonymous, select, true {} other { by {author}}}`,
        },
        {
          time: (
    ...
    },
    {
      ...
      label: formatMessage({
        id: 'custom-content-manager2.containers.edit.information.document.label',
        defaultMessage: 'Created',
      }),
      value: formatMessage(
        {
          id: 'custom-content-manager2.containers.edit.information.document.value',
          defaultMessage: `{time}{isAnonymous, select, true {} other { by {author}}}`,
        },
        {
          time: (
...
const EditTheModelAction: DocumentActionComponent = ({ model }) => {
  ...
  return isDesktop
    ? {
        label: formatMessage({
          id: 'custom-content-manager2.link-to-ctb',
...
const DeleteAction: DocumentActionComponent = ({ documentId, model, collectionType, document }) => {
  ...
  return {
    ...
    label: formatMessage(
      {
        id: 'custom-content-manager2.actions.delete.label',
      ...
      content: (
        <Flex direction="column" gap={2}>
          ...
          <Typography tag="p" variant="omega" textAlign="center">
            {formatMessage({
              id: 'custom-content-manager2.actions.delete.dialog.body',
          ...
          if (!documentId && collectionType !== SINGLE_TYPES) {
            ...
            toggleNotification({
              message: formatMessage({
                id: 'custom-content-manager2.actions.delete.error',
