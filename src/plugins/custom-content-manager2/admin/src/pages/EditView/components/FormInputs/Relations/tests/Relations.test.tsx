  ...
  renderRTL(
    ...
    />,
    {
      renderOptions: {
        wrapper: ({ children }) => (
          <Routes>
            <Route path="/custom-content-manager2/:collectionType/:slug/:id" element={children} />
          </Routes>
        ),
      },
      initialEntries: initialEntries ?? [
        '/custom-content-manager2/collection-types/api::address.address/12345',
      ],
    }
  );
...
describe('Relations', () => {
  ...
  it.skip('should by default render just the combobox', async () => {
    const { user } = render({
      initialEntries: ['/custom-content-manager2/collection-types/api::address.address/create'],
    });
  ...
  it('should render the relations list when there is data from the API', async () => {
    render({
      initialEntries: ['/custom-content-manager2/collection-types/api::address.address/12345'],
    });
