...
const render = ({
  initialEntries = [
    `/custom-content-manager2/collection-types/${mockData.contentManager.contentType}/configurations/list`,
  ],
} = {}) => ({
      ...
      wrapper({ children }) {
        return (
          <>
            <Routes>
              <Route
                path="/custom-content-manager2/:collectionType/:slug/configurations/list"
                element={children}
              />
            </Routes>
            <LocationDisplay />
