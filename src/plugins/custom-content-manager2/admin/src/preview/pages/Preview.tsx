...
const DEVICES = [
  {
    name: 'desktop',
    label: {
      id: 'custom-content-manager2.preview.device.desktop',
  ...
  },
  {
    name: 'mobile',
    label: {
      id: 'custom-content-manager2.preview.device.mobile',
  ...
  return (
    <>
      <Page.Title>
        {formatMessage(
          {
            id: 'custom-content-manager2.preview.page-title',
              ...
              >
                  ...
                  {hasAdvancedPreview && (
                    <IconButton
                      ...
                      label={formatMessage(
                        isSideEditorOpen
                          ? {
                              id: 'custom-content-manager2.preview.content.close-editor',
                              defaultMessage: 'Close editor',
                            }
                          : {
                              id: 'custom-content-manager2.preview.content.open-editor',
                  ...
                  <Flex justifyContent="center" flex={1}>
                    <SingleSelect
                      ...
                      aria-label={formatMessage({
                        id: 'custom-content-manager2.preview.device.select',
                ...
                <Flex direction="column" justifyContent="center" background="neutral0" flex={1}>
                  <Box
                    ...
                    key={previewUrl}
                    title={formatMessage({
                      id: 'custom-content-manager2.preview.panel.title',
...
const ProtectedPreviewPageImpl = () => {
  ...
  const {
    ...
    { action: 'plugin::custom-content-manager2.explorer.read', subject: model },
    { action: 'plugin::custom-content-manager2.explorer.update', subject: model },
    { action: 'plugin::custom-content-manager2.explorer.publish', subject: model },
  ]);
