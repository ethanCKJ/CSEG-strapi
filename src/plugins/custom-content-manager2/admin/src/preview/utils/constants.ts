...
export const PREVIEW_ERROR_MESSAGES = {
  INVALID_FIELD_PATH: {
    type: 'danger',
    message: {
      id: 'custom-content-manager2.preview.error.invalid-field-path',
  ...
  RELATIONS_NOT_HANDLED: {
    type: 'info',
    message: {
      id: 'custom-content-manager2.preview.error.relations-not-handled',
  ...
  INCOMPLETE_STRAPI_SOURCE: {
    type: 'danger',
    message: {
      id: 'custom-content-manager2.preview.error.incomplete-strapi-source',
  ...
  DIFFERENT_DOCUMENT: {
    type: 'info',
    message: {
      id: 'custom-content-manager2.preview.error.different-document',
