...
import type { PanelComponent } from '@strapi/custom-content-manager2/strapi-admin';
...
const PreviewSidePanel: PanelComponent = ({ model, documentId, document }) => {
  ...
  if (error && error.name === 'NotFoundError') {
    return {
      ...
      content: (
        ...
        >
          {formatMessage({
            id: 'custom-content-manager2.preview.panel.button-configuration',
  ...
  return {
    ...
    content: (
      <ConditionalTooltip
        label={formatMessage({
          id: 'custom-content-manager2.preview.panel.button-disabled-tooltip',
      ...
      >
        <Box cursor="not-allowed" width="100%">
          ...
          >
            {formatMessage({
              id: 'custom-content-manager2.preview.panel.button',
