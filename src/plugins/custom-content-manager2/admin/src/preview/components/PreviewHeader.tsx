...
import type { ContentManagerPlugin, DocumentActionProps } from '../../custom-content-manager2';
...
const ClosePreviewButton = () => {
  ...
  return (
    <IconButton
      ...
      onClick={handleClick}
      label={formatMessage({
        id: 'custom-content-manager2.preview.header.close',
  ...
  const handleCopyLink = () => {
    ...
    toggleNotification({
      message: formatMessage({
        id: 'custom-content-manager2.preview.copy.success',
