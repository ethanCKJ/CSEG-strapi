...
const VersionContent = () => {
  ...
  const { fieldSizes } = useTypedSelector((state) => state['custom-content-manager2'].app);
          ...
          <Box paddingTop={8}>
            <Flex direction="column" alignItems="flex-start" paddingBottom={6} gap={1}>
              <Typography variant="delta">
                {formatMessage({
                  id: 'custom-content-manager2.history.content.unknown-fields.title',
              ...
              <Typography variant="pi">
                {formatMessage(
                  {
                    id: 'custom-content-manager2.history.content.unknown-fields.message',
                    defaultMessage:
