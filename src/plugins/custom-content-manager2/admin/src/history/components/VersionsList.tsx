    ...
    >
      <Flex direction="column" gap={1} alignItems="flex-start">
        ...
        <Typography tag="p" variant="pi" textColor="neutral600">
          {formatMessage(
            {
              id: 'custom-content-manager2.history.sidebar.versionDescription',
              defaultMessage:
    ...
    >
      ...
      >
        <Typography tag="h2" variant="omega" fontWeight="semiBold">
          {formatMessage({
            id: 'custom-content-manager2.history.sidebar.title',
      ...
      <Box flex={1} overflow="auto">
        {versions.meta.pagination.page > 1 && (
          <Box paddingTop={4} textAlign="center">
            <PaginationButton page={page - 1}>
              {formatMessage({
                id: 'custom-content-manager2.history.sidebar.show-newer',
          ...
          {versions.data.map((version, index) => (
            <li
              ...
              aria-label={formatMessage({
                id: 'custom-content-manager2.history.sidebar.title.version-card.aria-label',
        ...
        {versions.meta.pagination.page < versions.meta.pagination.pageCount && (
          <Box paddingBottom={4} textAlign="center">
            <PaginationButton page={page + 1}>
              {formatMessage({
                id: 'custom-content-manager2.history.sidebar.show-older',
