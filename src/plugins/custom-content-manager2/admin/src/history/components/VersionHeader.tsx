    ...
    try {
      ...
      if ('data' in response) {
        ...
        toggleNotification({
          type: 'success',
          title: formatMessage({
            id: 'custom-content-manager2.restore.success.title',
            defaultMessage: 'Version restored.',
          }),
          message: formatMessage({
            id: 'custom-content-manager2.restore.success.message',
      ...
      if ('error' in response) {
        toggleNotification({
          type: 'danger',
          message: formatMessage({
            id: 'custom-content-manager2.history.restore.error.message',
    ...
    <Dialog.Root open={isConfirmDialogOpen} onOpenChange={setIsConfirmDialogOpen}>
      <Layouts.BaseHeader
        ...
        subtitle={
          <Typography variant="epsilon" textColor="neutral600">
            {formatMessage(
              {
                id: 'custom-content-manager2.history.version.subtitle',
                defaultMessage:
        ...
        primaryAction={
          <Dialog.Trigger>
            ...
            >
              {formatMessage({
                id: 'custom-content-manager2.history.restore.confirm.button',
      ...
      >
        ...
        >
          ...
          <Typography>
            {formatMessage({
              id: 'custom-content-manager2.history.restore.confirm.title',
          ...
          <Typography>
            {formatMessage(
              {
                id: 'custom-content-manager2.history.restore.confirm.message',
                defaultMessage:
