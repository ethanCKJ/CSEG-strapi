...
import { routes as previewRoutes } from './preview/routes';// MODIFIED: Load unprotected versions to bypass RBAC checks in Content Manager only
const EditViewPage = lazy(() =>
const ProtectedEditViewPage = lazy(() =>
  import('./pages/EditView/EditViewPage').then((mod) => ({ default: mod.ProtectedEditViewPage }))
  import('./pages/ListView/ListViewPage').then((mod) => ({ default: mod.ListViewPage }))
...
const CLONE_PATH = `/custom-content-manager2/${CLONE_RELATIVE_PATH}`;
const LIST_RELATIVE_PATH = ':collectionType/:slug';
const LIST_PATH = `/custom-content-manager2/collection-types/:slug`;
