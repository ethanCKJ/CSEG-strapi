...
describe('useDocumentActions', () => {
  ...
  describe('clone', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/:collectionType/:uid/clone/:id', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('create', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/:collectionType/:uid', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('delete', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.delete('/custom-content-manager2/:collectionType/:uid/:id', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('bulk delete', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/collection-types/:uid/actions/bulkDelete', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('discard', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/:collectionType/:uid/:id/actions/discard', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('publish', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/:collectionType/:uid/:id/actions/publish', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('update', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.put('/custom-content-manager2/:collectionType/:uid/:id', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('unpublish', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/:collectionType/:uid/:id/actions/unpublish', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
  ...
  describe('bulk unpublish', () => {
    ...
    it('should return the errors when unsuccessful', async () => {
      server.use(
        rest.post('/custom-content-manager2/collection-types/:uid/actions/bulkUnpublish', (_, res, ctx) => {
          return res(
            ctx.status(500),
            ctx.json({
