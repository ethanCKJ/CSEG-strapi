...
import { ContentManagerPlugin, DocumentActionComponent, PanelComponent } from '../custom-content-manager2';
...
describe('custom-content-manager2', () => {
  describe('config', () => {
