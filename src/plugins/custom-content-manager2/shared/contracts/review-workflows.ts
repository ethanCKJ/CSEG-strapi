...
/**
 * /custom-content-manager2/<collection-type | single-type>/:model/:id/assignee
 */
...
/**
 * GET /custom-content-manager2/<collection-type | single-type>/:model/:id/stages
 */
namespace GetStages {
  export interface Request {
    body: {};
...
/**
 * PUT /custom-content-manager2/<collection-type | single-type>/:model/:id/stage
 */
