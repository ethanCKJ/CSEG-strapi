...
const ACTIONS = {
  read: 'plugin::custom-content-manager2.explorer.read',
  create: 'plugin::custom-content-manager2.explorer.create',
  update: 'plugin::custom-content-manager2.explorer.update',
  delete: 'plugin::custom-content-manager2.explorer.delete',
  publish: 'plugin::custom-content-manager2.explorer.publish',
  unpublish: 'plugin::custom-content-manager2.explorer.publish',
  discard: 'plugin::custom-content-manager2.explorer.update',
} as const;
