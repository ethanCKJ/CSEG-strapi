    ...
    },
    {
      ...
      config: {
        ...
        policies: [
          ...
          {
            name: 'plugin::custom-content-manager2.hasPermissions',
            config: { actions: ['plugin::custom-content-manager2.explorer.read'] },
          },
        ],
      },
    },
      ...
      config: {
        ...
        policies: [
          'admin::isAuthenticatedAdmin',
          {
            ...
            config: {
              actions: [
                'plugin::custom-content-manager2.explorer.create',
                'plugin::custom-content-manager2.explorer.update',
              ],
              hasAtLeastOne: true,
            },
          },
    ...
    },
    {
      ...
      config: {
        ...
        policies: [
          ...
          {
            name: 'plugin::custom-content-manager2.hasPermissions',
            config: { actions: ['plugin::custom-content-manager2.explorer.delete'] },
          },
        ],
      },
    },
    {
      ...
      config: {
        ...
        policies: [
          ...
          {
            name: 'plugin::custom-content-manager2.hasPermissions',
            config: { actions: ['plugin::custom-content-manager2.explorer.publish'] },
          },
        ],
      },
    },
    ...
    },
    {
      ...
      config: {
        ...
        policies: [
          ...
          {
            name: 'plugin::custom-content-manager2.hasPermissions',
            config: { actions: ['plugin::custom-content-manager2.explorer.update'] },
          },
        ],
      },
    },
    ...
    },
    {
      ...
      config: {
        ...
        policies: [
          ...
          {
            name: 'plugin::custom-content-manager2.hasPermissions',
            config: { actions: ['plugin::custom-content-manager2.explorer.create'] },
          },
        ],
      },
    },
