...
const createHomepageService = ({ strapi }: { strapi: Core.Strapi }) => {
  ...
  const metadataService = strapi.plugin('custom-content-manager2').service('document-metadata');
  ...
  const permissionCheckerService = strapi.plugin('custom-content-manager2').service('permission-checker');
