...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative600", children: /* @__PURE__ */ jsx(Typography, { variant: "delta", color: "alternative600", children: attribute?.options?.dividerText }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-zP3kmQJf.mjs.map
