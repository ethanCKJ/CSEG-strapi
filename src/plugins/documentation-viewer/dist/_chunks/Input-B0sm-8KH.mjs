...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative400", padding: 1, children: /* @__PURE__ */ jsx(Typography, { variant: "delta", children: attribute?.options?.dividerText || /* @__PURE__ */ jsx("hr", {}) }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-B0sm-8KH.mjs.map
