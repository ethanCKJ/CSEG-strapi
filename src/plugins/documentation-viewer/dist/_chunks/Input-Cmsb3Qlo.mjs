...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative600", color: "black", paddingX: 1, children: /* @__PURE__ */ jsx(Typography, { variant: "delta", children: attribute?.options?.dividerText || /* @__PURE__ */ jsx("hr", {}) }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-Cmsb3Qlo.mjs.map
