...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative600", children: /* @__PURE__ */ jsx(Typography, { variant: "delta", color: "alternative600", children: "Divider" }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-31jXzIBn.mjs.map
