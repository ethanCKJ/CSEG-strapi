...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative600", color: "", children: /* @__PURE__ */ jsx(Typography, { variant: "delta", color: "alternative600", children: attribute?.options?.dividerText || /* @__PURE__ */ jsx("hr", {}) }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-BBLwwHNr.mjs.map
