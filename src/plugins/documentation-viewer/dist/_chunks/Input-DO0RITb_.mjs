...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative200", children: /* @__PURE__ */ jsx(Typography, { variant: "delta", children: attribute?.options?.dividerText || /* @__PURE__ */ jsx("hr", {}) }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-DO0RITb_.mjs.map
