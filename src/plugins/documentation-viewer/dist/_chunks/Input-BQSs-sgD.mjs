...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { c: true, children: /* @__PURE__ */ jsx(Typography, { variant: "delta", color: "alternative600", children: "Divider" }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-BQSs-sgD.mjs.map
