...
const Input = ({
  ...
  return /* @__PURE__ */ jsx(Box, { background: "alternative600", padding: 1, children: /* @__PURE__ */ jsx(Typography, { variant: "delta", children: attribute?.options?.dividerText || /* @__PURE__ */ jsx("hr", {}) }) });
};
export {
  Input as default
};
//# sourceMappingURL=Input-D6PZAp2m.mjs.map
