 ...
 * including the layouts for the components used in the content-type. It's a light wrapper around the `useDocument` hook,
 * but provides the `skip` option so a document is not fetched. However, it does fetch the schemas & components if they
