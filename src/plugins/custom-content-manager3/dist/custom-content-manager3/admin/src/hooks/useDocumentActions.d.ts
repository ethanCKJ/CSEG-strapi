...
type UseDocumentActions = (fromPreview?: boolean, fromRelationModal?: boolean) => {
    ...
    clone: (args: {
        ...
        documentId: string;
        params?: object;
    }, document: Omit<Document, 'id'>) => Promise<OperationResponse<Clone.Response>>;
    create: (args: {
        model: string;
        params?: object;
    }, document: Omit<Document, 'id'>) => Promise<OperationResponse<Create.Response>>;
    delete: (args: {
    ...
    update: (args: {
        ...
        documentId?: string;
        params?: object;
    }, document: Partial<Document>) => Promise<OperationResponse<Update.Response>>;
    unpublish: (args: {
        collectionType: string;
        model: string;
        documentId?: string;
