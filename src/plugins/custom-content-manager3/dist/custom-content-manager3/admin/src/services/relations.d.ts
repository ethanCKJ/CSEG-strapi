...
}, "adminApi">>, useSearchRelationsQuery: import("@reduxjs/toolkit/dist/query/react/buildHooks").UseQuery<import("@reduxjs/toolkit/query").QueryDefinition<FindAvailable.Params & {
    params?: (Partial<Pick<import("../../../shared/contracts/relations").Pagination, "page" | "pageSize">> & {
        id?: import("@strapi/types/dist/data").ID | undefined;
        locale?: string | undefined;
        _filter?: string | undefined;
