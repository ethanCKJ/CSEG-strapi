...
const ProtectedListViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListViewPage-fgFn6ii0.js")).then((n) => n.ListViewPage).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
const CollectionTypePages = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ProtectedListViewPage, {});
};
...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      to: `plugins/${PLUGIN_ID$1}`,
      icon: Icons.Bell,
      intlLabel: {
        id: `${PLUGIN_ID$1}.plugin.name`,
        defaultMessage: PLUGIN_ID$1
      },
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-Y17rQgss.js"));
        return App;
      }
    });
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await Promise.resolve().then(() => require("./layout-n8RGe7Y0.js"));
        return {
          Component: Layout
        };
      },
...
exports.PLUGIN_ID = PLUGIN_ID$1;
exports.PLUGIN_ID$1 = PLUGIN_ID;
exports.SINGLE_TYPES = SINGLE_TYPES;
exports.index = index;
exports.setInitialData = setInitialData;
//# sourceMappingURL=index-CJAgv_Ni.js.map
