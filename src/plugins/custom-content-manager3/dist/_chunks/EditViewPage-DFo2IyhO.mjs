...
import { Status, Typography, Button, Dialog, Modal, Tabs, Flex, IconButton, Loader, EmptyStateLayout, Box, TextButton, SingleSelect, SingleSelectOption, Popover, Field, Menu, Tooltip, useComposedRefs, VisuallyHidden, Divider, Accordion, Grid as Grid$1, Combobox, ComboboxOption, Link as Link$2, TextInput, IconButtonGroup, Radio, SimpleMenu, MenuItem, Main } from "@strapi/design-system";
import { useIntl } from "react-intl";
import { useParams, useNavigate, useLocation, useMatch } from "react-router-dom";
import { styled, css, createGlobalStyle, keyframes } from "styled-components";
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DDNflbrv.mjs";
        ...
        Flex,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(FlexWrapper, { gap: 1, children: [
              ...
              /* @__PURE__ */ jsx("div", { children: "HDFsfadf" }),
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Button, { onClick: handleEmailTemplates, children: "Update Event Dates" }),
    /* @__PURE__ */ jsx(
      StandardActionPanel,
      {
        model,
...
//# sourceMappingURL=EditViewPage-DFo2IyhO.mjs.map
