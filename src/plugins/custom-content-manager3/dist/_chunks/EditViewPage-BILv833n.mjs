...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-BzlCOjNi.mjs";
      ...
      for (let i = 0; i < emailTemplateName.length; i++) {
        ...
        if (res.data.data && res.data.data.template) {
          ...
          if (typeof formValues.eventDate === "string" && formValues.eventDate.trim() !== "") {
            eventDate = new Date(formValues.eventDate.trim()).toLocaleDateString();
          }
...
//# sourceMappingURL=EditViewPage-BILv833n.mjs.map
