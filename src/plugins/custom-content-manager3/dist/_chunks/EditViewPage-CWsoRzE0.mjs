...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-BPBGSzwZ.mjs";
    ...
    try {
      for (let i = 0; i < emailTemplateName.length; i++) {
        ...
        if (res.data.data && res.data.data.template) {
          const template2 = res.data.data.template;
        } else {
          throw new Error("Template not found");
        }
        const lodashTemplate = template();
      }
    } catch (e) {
...
//# sourceMappingURL=EditViewPage-CWsoRzE0.mjs.map
