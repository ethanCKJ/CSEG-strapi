...
const index = require("./index-C6iJO1ko.js");
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", gap: 2, alignItems: "start", children: data.results.map((email) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", padding: 2, borderColor: "neutral150", borderWidth: "1px", hasRadius: true, background: "neutral100", children: [
...
//# sourceMappingURL=EditViewPage-C4CrGVmc.js.map
