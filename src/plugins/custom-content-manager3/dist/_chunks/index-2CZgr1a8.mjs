...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-WsaDVXrk.mjs").then((n) => n.E).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-BKMtM7t9.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = lazy(
  () => import("./ListTabbedPage-IjdFHCNj.mjs").then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-UndsVIeF.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-2CZgr1a8.mjs.map
