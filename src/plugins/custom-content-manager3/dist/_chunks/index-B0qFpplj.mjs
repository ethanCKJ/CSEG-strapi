...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-CN9sB7Jq.mjs").then((n) => n.E).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-DEvu2_ln.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = lazy(
  () => import("./ListTabbedPage-CORAdOnm.mjs").then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-CjvhE2Z_.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-B0qFpplj.mjs.map
