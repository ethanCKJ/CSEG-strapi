...
const Filters = require("./Filters-DoCk-rRV.js");
const EditViewPage = require("./EditViewPage-DGGqlw_Q.js");
const index = require("./index-Bvxl9GOx.js");
...
const ListViewPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Title, { children: `${contentTypeTitle} I am a dummy change` }),
