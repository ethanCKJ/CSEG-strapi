...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-Bc_RklF9.mjs";
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  if (isLoading) {
    ...
    return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, alignItems: "start", children: [
      /* @__PURE__ */ jsx(Typography, { children: "No scheduled emails found. Make sure you selected mailing lists " }),
...
//# sourceMappingURL=EditViewPage-BVMmDy38.mjs.map
