...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DYymI-Fp.mjs";
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  return /* @__PURE__ */ jsx(Flex, { direction: "column", gap: 2, children: data.results.map((email) => /* @__PURE__ */ jsxs(Flex, { direction: "column", padding: 2, borderColor: "neutral150", borderWidth: "1px", hasRadius: true, background: "neutral100", children: [
...
//# sourceMappingURL=EditViewPage-Dmbqf5DD.mjs.map
