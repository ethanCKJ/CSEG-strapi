...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DBN_4S0_.mjs";
...
const EventActionPanel = ({
  ...
  useForm("EventActionPanel", ({ values }) => values);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      StandardActionPanel,
      {
...
//# sourceMappingURL=EditViewPage-BpAfWV6h.mjs.map
