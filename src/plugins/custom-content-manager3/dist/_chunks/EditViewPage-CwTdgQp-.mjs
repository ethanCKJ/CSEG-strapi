...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DSl-dued.mjs";
...
const EventActionPanel = ({
  ...
  const handleEmailTemplates = async () => {
    ...
    for (let i = 0; i < emailTemplateName.length; i++) {
      onChange(`disableEmail${i + 1}`, true);
    }
    let templateName = "";
    try {
...
//# sourceMappingURL=EditViewPage-CwTdgQp-.mjs.map
