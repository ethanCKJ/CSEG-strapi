...
const index = require("./index-aE_YQEc_.js");
...
const DocumentActionConfirmDialog$1 = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Root, { open: isOpen, onOpenChange: handleClose, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Header, { children: title2 }),
...
const DocumentActionModal = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { open: isOpen, onOpenChange: handleClose, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Title, { children: title2 }) }),
...
const DynamicComponent = ({
  ...
  const title2 = React__namespace.useMemo(() => {
  ...
  const [{ handlerId, isDragging, handleKeyDown }, boxRef, dropRef, dragRef, dragPreviewRef] = useDragAndDrop(!disabled, {
    ...
    item: {
      index: index$1,
      displayedValue: `${displayName} ${title2}`,
      icon
    },
  ...
  const accordionTitle = title2 ? `${displayName} ${title2}` : displayName;
...
const Header = ({ isCreating, status, title: documentTitle = "Untitled" }) => {
  ...
  const title2 = isCreating ? "Create an entry" : documentTitle;
  return /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Flex,
    {
      direction: "column",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Flex,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "alpha", tag: "h1", children: title2 })
          }
        ),
...
React__namespace.forwardRef(({ children, title: title2 }, ref) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Flex,
    {
      ref,
      ...
      alignItems: "flex-start",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { tag: "h2", variant: "sigma", textTransform: "uppercase", textColor: "neutral600", children: title2 }),
        children
      ]
    }
  );
...
const EventActionPanel = ({
  ...
  const emailTemplateTitles = ["event-7-days-before", "event-7-days-before", "event-on-day-itself"];
  const [loadingTemplates, setLoadingTemplates] = React__namespace.useState(false);
  const handleEmailTemplates = async () => {
    setLoadingTemplates(true);
    try {
      for (let i = 0; i < emailTemplateTitles.length; i++) {
        const title2 = emailTemplateTitles[i];
      }
    } catch (e) {
      const message = e instanceof Error ? e.message : "Unknown error";
      console.error("Error loading template", title, "with message", message);
    } finally {
      setLoadingTemplates(false);
    }
    const abstract = formValues.abstract ?? "[Please copy and paste abstract here]";
    const eventDate = formValues.eventDate ?? "[Please copy and paste date here]";
    const eventStartTime = formValues.eventStartTime ?? "[Please copy and paste start time here]";
    const eventEndTime = formValues.eventEndTime ?? "[Please copy and paste end time here]";
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleEmailTemplates, loading: loadingTemplates, children: "Generate Emails" }),
    /* @__PURE__ */ jsxRuntime.jsx(
      StandardActionPanel,
      {
        model,
...
//# sourceMappingURL=EditViewPage-CL_Q8H1X.js.map
