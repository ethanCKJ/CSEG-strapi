...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-ZaRYQp2w.mjs";
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, padding: 2, alignItems: "start", background: "neutral100", width: "100%", children: [
    /* @__PURE__ */ jsx(Typography, { children: "Note you cannot disable an email that has already been sent. Delete using the disab" }),
    /* @__PURE__ */ jsx(Button, { onClick: handleRefresh, loading: isFetching, size: "S", variant: "secondary", children: "Refresh" }),
...
//# sourceMappingURL=EditViewPage-XzvHXnR9.mjs.map
