...
import { Status, Typography, Button, Dialog, Modal, Tabs, Flex, IconButton, TextButton, Loader, EmptyStateLayout, Box, SingleSelect, SingleSelectOption, Popover, Field, Menu, Tooltip, useComposedRefs, VisuallyHidden, Divider, Accordion as Accordion$1, Grid as Grid$1, Combobox, ComboboxOption, Link as Link$2, TextInput, IconButtonGroup, Radio, SimpleMenu, MenuItem, Main } from "@strapi/design-system";
import { useIntl } from "react-intl";
import { useParams, useNavigate, useLocation, useMatch } from "react-router-dom";
import { styled, css, createGlobalStyle, keyframes } from "styled-components";
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DDZjFEj_.mjs";
...
const AccordionRoot = styled(Accordion$1.Root)`
  border: 1px solid
...
const Component = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: isDragging ? /* @__PURE__ */ jsx(Preview$1, {}) : /* @__PURE__ */ jsxs(Accordion$1.Item, { ref: composedBoxRefs, value: __temp_key__, children: [
    /* @__PURE__ */ jsxs(Accordion$1.Header, { children: [
      /* @__PURE__ */ jsx(Accordion$1.Trigger, { children: displayValue }),
      /* @__PURE__ */ jsxs(Accordion$1.Actions, { children: [
        /* @__PURE__ */ jsx(
          IconButton,
          {
            disabled,
    ...
    /* @__PURE__ */ jsx(Accordion$1.Content, { children: /* @__PURE__ */ jsx(
      Flex,
      {
        direction: "column",
        alignItems: "stretch",
...
const ComponentCategory = ({
  ...
  const { formatMessage } = useIntl();
  return /* @__PURE__ */ jsxs(Accordion$1.Item, { value: category, children: [
    /* @__PURE__ */ jsx(Accordion$1.Header, { variant, children: /* @__PURE__ */ jsx(Accordion$1.Trigger, { children: formatMessage({ id: category, defaultMessage: category }) }) }),
...
const ResponsiveAccordionContent = styled(Accordion$1.Content)`
  ...
  return /* @__PURE__ */ jsxs(
    Box,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: /* @__PURE__ */ jsx(Accordion$1.Root, { defaultValue: Object.keys(dynamicComponentsByCategory)[0], children: Object.entries(dynamicComponentsByCategory).map(([category, components], index) => /* @__PURE__ */ jsx(
          ComponentCategory,
          {
            category,
            components,
...
const DynamicComponent = ({
  ...
  return /* @__PURE__ */ jsxs(ComponentContainer, { tag: "li", width: "100%", children: [
    ...
    /* @__PURE__ */ jsx(StyledBox, { ref: composedBoxRefs, hasRadius: true, children: isDragging ? /* @__PURE__ */ jsx(Preview, {}) : /* @__PURE__ */ jsx(Accordion$1.Root, { value: collapseToOpen, onValueChange: setCollapseToOpen, children: /* @__PURE__ */ jsxs(Accordion$1.Item, { value: accordionValue, children: [
      /* @__PURE__ */ jsxs(Accordion$1.Header, { children: [
        /* @__PURE__ */ jsx(
          Accordion$1.Trigger,
          {
        ...
        /* @__PURE__ */ jsx(Accordion$1.Actions, { children: accordionActions })
      ] }),
      /* @__PURE__ */ jsx(Accordion$1.Content, { children: /* @__PURE__ */ jsx(AccordionContentRadius, { background: "neutral0", children: /* @__PURE__ */ jsx(Box, { paddingLeft: 6, paddingRight: 6, paddingTop: 6, paddingBottom: 6, children: /* @__PURE__ */ jsx(Grid$1.Root, { gap: 4, children: components[componentUid]?.layout?.map((row, rowInd) => {
        const visibleFields = row.filter(({ ...field }) => {
          const condition = field.attribute.conditions?.visible;
          if (condition) {
            return rulesEngine2.evaluate(condition, value);
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Accordion.Root, { variant: "secondary", children: /* @__PURE__ */ jsxs(Accordion.Item, { value: "acc-01", children: [
      /* @__PURE__ */ jsx(Accordion.Header, { children: /* @__PURE__ */ jsx(Accordion.Trigger, { description: "Your personal information", children: "User information" }) }),
      /* @__PURE__ */ jsx(Accordion.Content, { children: /* @__PURE__ */ jsx(Typography, { display: "block", padding: 4, children: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat." }) })
    ] }) })
  ] });
};
...
//# sourceMappingURL=EditViewPage-DCLxEMYu.mjs.map
