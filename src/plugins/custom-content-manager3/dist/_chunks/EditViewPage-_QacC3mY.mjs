...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-COxI4feV.mjs";
...
const EventActionPanel = ({
  ...
  const { data: scheduledEmails, isLoading: isLoadingScheduledEmails, error: scheduledEmailsError } = useScheduledEmails(model, documentId || "", [1, 2, 3]);
  React.useEffect(() => {
    console.log("useScheduledEmails state:", {
      isLoading: isLoadingScheduledEmails,
      hasData: !!scheduledEmails,
      dataResultsLength: scheduledEmails?.results?.length,
      error: scheduledEmailsError,
      model,
      documentId
    });
  ...
  }, [isLoadingScheduledEmails, scheduledEmails, scheduledEmailsError, model, documentId]);
...
//# sourceMappingURL=EditViewPage-_QacC3mY.mjs.map
