...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-CSasaVdc.mjs";
    ...
    try {
      ...
      for (let i = 0; i < emailTemplateName.length; i++) {
        ...
        if (!isNaN(parsedEventDate.getTime())) {
          const defaultDate = combineDateAndTime(new Date(parsedEventDate.getDate() - daysBefore[i]), new Date(2020, 0, 1, 9, 0, 0));
          const emailDate = new Date(parsedEventDate);
          emailDate.setDate(emailDate.getDate() - daysBefore[i]);
          onChange(`emailDate${i + 1}`, emailDate.toISOString().substring(0, 10));
        }
...
//# sourceMappingURL=EditViewPage-DmCp1IoS.mjs.map
