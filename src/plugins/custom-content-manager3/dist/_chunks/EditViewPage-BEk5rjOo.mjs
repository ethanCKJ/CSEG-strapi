...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-CrsvVP6h.mjs";
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    formValues.showDisableToggles === false && /* @__PURE__ */ jsx(Button, { onClick: handleEmailTemplates, loading: loadingTemplates, children: "Generate Email Templates" }),
    /* @__PURE__ */ jsx(
      StandardActionPanel,
      {
        model,
...
//# sourceMappingURL=EditViewPage-BEk5rjOo.mjs.map
