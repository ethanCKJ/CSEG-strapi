...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-Bl7EPrDT.mjs").then((n) => n.E).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-Cp9WGh26.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = lazy(
  () => import("./ListTabbedPage-BZBb210J.mjs").then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-DkoJ3dt8.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-C40y3hfr.mjs.map
