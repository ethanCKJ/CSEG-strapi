...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-SxU0bGOj.mjs";
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Button, { onClick: handleEmailTemplates, children: "Generate Emails" }),
    /* @__PURE__ */ jsx(
      StandardActionPanel,
      {
        model,
...
//# sourceMappingURL=EditViewPage-Ctxf_fpB.mjs.map
