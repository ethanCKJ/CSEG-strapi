...
import { createRulesEngine, adminApi, translatedErrors, useNotification, useAPIErrorHandler, useQueryParams, getYupValidationErrors, createContext, useAuth, useRBAC, Page, useForm, Blocker as Blocker$1, useStrapiApp, useField, useElementOnScreen, useIsDesktop, useFocusInputField, InputRenderer, BackButton, DescriptionComponentRenderer, useDebounce as useDebounce$1, useFetchClient, RESPONSIVE_DEFAULT_SPACING, Form, ConfirmDialog } from "@strapi/strapi/admin";
import * as Icons from "@strapi/icons";
import { CodeBlock as CodeBlock$1, HeadingSix, HeadingFive, HeadingFour, HeadingThree, HeadingTwo, HeadingOne, Image as Image$1, BulletList, NumberList, Paragraph, Quotes, More, Link as Link$1, Drag, Collapse, Code, StrikeThrough, Underline, Italic, Bold, Expand, PlusCircle, Plus, Trash, ArrowClockwise, Cross, CheckCircle, WarningCircle, Loader, ArrowLeft, Mail, ArrowLineLeft, ArrowsOut } from "@strapi/icons";
import { Status, Typography, Box, SingleSelect, SingleSelectOption, Flex, Button, Popover, Field, Menu, IconButton, Tooltip, useComposedRefs, Modal, Divider, VisuallyHidden, Accordion, TextButton, Grid as Grid$1, Combobox, ComboboxOption, Link as Link$2, TextInput, IconButtonGroup, Dialog, Radio, SimpleMenu, MenuItem, Tabs, Main, Loader as Loader$1, EmptyStateLayout } from "@strapi/design-system";
import { useIntl } from "react-intl";
import { styled, css, createGlobalStyle, keyframes } from "styled-components";
import { S as SINGLE_TYPES, C as COLLECTION_TYPES, b as CLONE_PATH, L as LIST_PATH } from "./index-D2iAzhCr.mjs";
...
import { useFocused, useSelected, ReactEditor, Editable, useSlate, withReact, Slate } from "slate-react";
  ...
  return /* @__PURE__ */ jsxs(Flex, { gap: 2, children: [
    /* @__PURE__ */ jsx(
      DescriptionComponentRenderer,
      {
        ...
        children: (actions) => {
          if (actions.length > 0) {
            return /* @__PURE__ */ jsx(HeaderActions, { actions });
          } else {
            return null;
          }
        }
...
const HeaderActions = ({ actions }) => {
  ...
  return /* @__PURE__ */ jsx(Flex, { gap: 1, children: actions.map((action) => {
    if (action.options) {
      return /* @__PURE__ */ jsx(
        SingleSelect,
        {
          ...
          children: action.options.map(({ label, ...option }) => {
            ...
            return /* @__PURE__ */ jsx(SingleSelectOption, { ...option, children: label }, option.value);
          })
        },
        action.id
      );
    } else if (action._status) {
      return /* @__PURE__ */ jsx(HeaderActionStatus, { tooltip: action._status?.tooltip, children: action._status.message }, action.id);
    } else {
...
const HeaderActionStatus = ({ tooltip, children }) => {
  const [open, setOpen] = React.useState(false);
  const debouncedOpen = useDebounce$1(open, 100);
  ...
  return /* @__PURE__ */ jsxs(Popover.Root, { open: debouncedOpen, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsx(
      Popover.Anchor,
      {
        ...
        children: /* @__PURE__ */ jsx(Box, { height: "100%", children })
      }
    ),
    /* @__PURE__ */ jsx(
      Popover.Content,
...
const useSendEmailAction = (documentId, model, collectionType) => {
  ...
  const modified = useForm("sendEmailAction", ({ modified: modified2 }) => modified2);
  const documentForm = useForm("sendEmailAction", ({ values }) => values);
  const emailCount = documentForm?.emailCount || 0;
  ...
  const sendEmailDialogContent = /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 3, alignItems: "center", children: [
    /* @__PURE__ */ jsx(WarningCircle, { width: "24px", height: "24px" }),
    /* @__PURE__ */ jsx(Typography, { tag: "p", variant: "omega", textAlign: "center", children: "Are you sure you want to send email notifications for this document?" }),
    emailCount > 0 && /* @__PURE__ */ jsxs(Typography, { textColor: "danger600", textAlign: "center", children: [
      "You have previously sent ",
      emailCount,
      " notification(s). Are you sure you want to send more?"
    ] }),
    modified && /* @__PURE__ */ jsx(Typography, { textColor: "neutral600", textAlign: "center", variant: "pi", children: "Note: The document will be saved before sending emails." })
  ] });
  return {
...
const SendEmailButton = ({ documentId, model, collectionType }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      Button,
      {
        ...
        children: sendEmailAction.label
      }
    ),
    dialog && /* @__PURE__ */ jsx(
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(SendEmailButton, { model, collectionType, documentId })
  ] });
};
    ...
    /* @__PURE__ */ jsxs(
      Menu.Trigger,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(VisuallyHidden, { tag: "span", children: label || "More document actions" })
        ]
      }
    ),
      ...
      actions.map((action) => {
        return /* @__PURE__ */ jsx(
          Menu.Item,
          {
            ...
            startIcon: action.icon,
            children: /* @__PURE__ */ jsx(Flex, { justifyContent: "space-between", gap: 4, children: /* @__PURE__ */ jsx(Flex, { gap: 2, tag: "span", children: action.label }) })
          },
          action.id
        );
      }),
...
const RelationModalForm = () => {
  ...
  if (isLoading && !currentDocument.document?.documentId) {
    return /* @__PURE__ */ jsx(Loader$1, { small: true, children: formatMessage({
...
export {
  ADMIN_HIDDEN_FIELDS as A,
  CREATOR_FIELDS as C,
  DocumentStatus as D,
  HOOKS as H,
  MEMBER_APPLICATION_MODEL as M,
  ProtectedEditViewPage as P,
  useDocumentLayout as a,
  usePrev as b,
  buildValidParams as c,
  useGetAllDocumentsQuery as d,
  getDisplayName as e,
  convertListLayoutToFieldLayouts as f,
  getTranslation as g,
  useGetInitialDataQuery as h,
  useGetAllContentTypeSettingsQuery as i,
  useContentTypeSchema as j,
  useDeleteAction as k,
  DocumentActionConfirmDialog as l,
  getRelationLabel as m,
  useGetRelationsQuery as n,
  checkIfAttributeIsDisplayable as o,
  prefixFileUrlWithBackendUrl as p,
  useGetContentTypeConfigurationQuery as q,
  getMainField as r,
  useDebounce as s,
  useDoc as u
};
//# sourceMappingURL=useDeleteAction-DqMEfkh9.mjs.map
