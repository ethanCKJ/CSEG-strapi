...
const ProtectedEditViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./EditViewPage-BYh9vXsR.js")).then((n) => n.EditViewPage).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListViewPage-DchO2U8j.js")).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListTabbedPage-pbvqEDg1.js")).then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await Promise.resolve().then(() => require("./layout-565xRVeS.js"));
        return {
          Component: Layout
        };
      },
...
exports.index = index;
//# sourceMappingURL=index-BQOqdLN7.js.map
