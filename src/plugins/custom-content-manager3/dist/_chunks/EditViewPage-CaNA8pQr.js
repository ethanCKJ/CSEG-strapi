...
const index = require("./index-o2H4F3qt.js");
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  if (isLoading) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, alignItems: "start", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: "No scheduled emails found. Make sure you selected mailing lists in the " }),
...
//# sourceMappingURL=EditViewPage-CaNA8pQr.js.map
