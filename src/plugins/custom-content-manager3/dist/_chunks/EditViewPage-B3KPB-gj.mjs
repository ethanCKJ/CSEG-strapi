...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-BQJDw_gP.mjs";
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, alignItems: "start", background: "neutral100", width: "100%", children: [
    /* @__PURE__ */ jsx(Button, { onClick: handleRefresh, loading: isFetching, size: "S", variant: "secondary", children: "Refresh" }),
    /* @__PURE__ */ jsx(Typography, { children: "Note you cannot delete an email that has already been sent" }),
...
//# sourceMappingURL=EditViewPage-B3KPB-gj.mjs.map
