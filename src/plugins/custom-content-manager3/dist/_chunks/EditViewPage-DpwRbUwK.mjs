...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-BI5AIeb_.mjs";
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  return /* @__PURE__ */ jsx(Flex, { direction: "column", gap: 2, alignItems: "start", background: "neutral100", children: data.results.map((email) => /* @__PURE__ */ jsxs(Flex, { direction: "column", padding: 2, borderColor: "neutral150", borderWidth: "1px", hasRadius: true, width: "100%", children: [
...
//# sourceMappingURL=EditViewPage-DpwRbUwK.mjs.map
