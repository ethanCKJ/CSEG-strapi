...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-BcChu-Lp.mjs";
  ...
  const handleEmailTemplates = async () => {
    ...
    try {
      for (let i = 0; i < emailTemplateName.length; i++) {
        onChange(`emailSubject${i + 1}`, formValues.title ?? "Untitled subject");
...
//# sourceMappingURL=EditViewPage-CyaTFX5c.mjs.map
