...
const DynamicComponent = ({
  ...
  const title = React__namespace.useMemo(() => {
    ...
    const mainFieldValue = getIn(formValues, `${name2}.${index2}.${mainField}`);
    const displayedValue = mainField === "id" || !mainFieldValue ? "" : String(mainFieldValue).trim();
    const mainValue = displayedValue.length > 0 ? `- ${displayedValue}` : displayedValue;
    return mainValue;
  }, [componentUid, components, formValues, name2, index2]);
  ...
  const { value = [], rawError } = admin.useField(`${name2}.${index2}`);
  const [collapseToOpen, setCollapseToOpen] = React__namespace.useState("");
  React__namespace.useEffect(() => {
    if (rawError && value) {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Menu.Content, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Menu.SubRoot, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Menu.SubContent, { children: Object.entries(dynamicComponentsByCategory).map(([category, components2]) => /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.Fragment, { children: [
            ...
            components2.map(({ displayName: displayName2, uid }) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Menu.Item, { onSelect: () => onAddComponent(uid, index2), children: displayName2 }, uid))
          ] }, category)) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Menu.SubRoot, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Menu.SubTrigger, { children: formatMessage({
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Menu.SubContent, { children: Object.entries(dynamicComponentsByCategory).map(([category, components2]) => /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Menu.Label, { children: category }),
            components2.map(({ displayName: displayName2, uid }) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Menu.Item, { onSelect: () => onAddComponent(uid, index2 + 1), children: displayName2 }, uid))
          ] }, category)) })
        ] })
      ] })
    ] })
        ...
        return /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Grid.Item,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(ResponsiveGridRoot, { gap: 4, children: visibleFields.map(({ size, ...field }) => {
              const fieldName = `${name2}.${index2}.${field.name}`;
...
const RelationsList = ({
  ...
  const handleDropItem = (index2) => {
    const { href: _href, label, ...item } = data[index2];
    setLiveText(
      formatMessage(
        {
          id: getTranslation("dnd.drop-item"),
        ...
        designSystem.Flex,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 4, children: /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.IconButton,
              {
                onClick: () => handleDisconnect(relations[index2]),
                disabled,
                label: formatMessage({
...
const HeaderToolbar = () => {
  ...
  const plugins = admin.useStrapiApp("HeaderToolbar", (state) => state.plugins);
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      admin.DescriptionComponentRenderer,
      {
        ...
        children: (actions) => {
          if (actions.length > 0) {
            return /* @__PURE__ */ jsxRuntime.jsx(HeaderActions, { actions });
          } else {
            return null;
          }
        }
...
const HeaderActions = ({ actions }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: 1, children: actions.map((action) => {
    if (action.options) {
      return /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.SingleSelect,
        {
          ...
          children: action.options.map(({ label, ...option }) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { ...option, children: label }, option.value);
          })
        },
        action.id
      );
    } else if (action._status) {
      return /* @__PURE__ */ jsxRuntime.jsx(HeaderActionStatus, { tooltip: action._status?.tooltip, children: action._status.message }, action.id);
    } else {
...
const HeaderActionStatus = ({ tooltip, children }) => {
  const [open, setOpen] = React__namespace.useState(false);
  const debouncedOpen = admin.useDebounce(open, 100);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Popover.Root, { open: debouncedOpen, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Popover.Anchor,
      {
        style: { alignSelf: "stretch" },
        onMouseEnter: handleMouseEnter,
        onMouseLeave: handleMouseLeave,
        "aria-describedby": "document-header-action-status",
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { height: "100%", children })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
...
const useSendEmailAction = (documentId, model, collectionType) => {
  ...
  const [isMailDialogOpen, setIsMailDialogOpen] = React__namespace.useState(false);
  const [isSending, setIsSending] = React__namespace.useState(false);
  const modelSingular = model.substring(5, model.indexOf("."));
  const modified = admin.useForm("sendEmailAction", ({ modified: modified2 }) => modified2);
  const documentForm = admin.useForm("sendEmailAction", ({ values }) => values);
  ...
  const sendEmailDialogContent = /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 3, alignItems: "center", children: [
    /* @__PURE__ */ jsxRuntime.jsx(Icons.WarningCircle, { width: "24px", height: "24px" }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { tag: "p", variant: "omega", textAlign: "center", children: "Are you sure you want to send email notifications for this document?" }),
    emailCount > 0 && /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { textColor: "danger600", textAlign: "center", children: [
      "You have previously sent ",
      emailCount,
      " notification(s). Are you sure you want to send more?"
    ] }),
    modified && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral600", textAlign: "center", variant: "pi", children: "Note: The document will be saved before sending emails." })
  ] });
  return {
    ...
    icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Mail, {}),
    variant: "secondary",
    dialog: {
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(SendEmailButton, { model, collectionType, documentId })
  ] });
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "center", width: "100%", gap: 8, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, justifyContent: "center", alignItems: "center", width: "50%", children: [
        /* @__PURE__ */ jsxRuntime.jsx(PublishButton, { documentId, activeTab: status, model, collectionType, meta, document: document2 }),
        /* @__PURE__ */ jsxRuntime.jsx(UpdateButton, { activeTab: status, documentId, model, collectionType })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SimpleMenu, { label: "More actions", variant: "tertiary", children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.MenuItem, { onSelect: deleteAction.dialog?.open, variant: deleteAction.variant, startIcon: deleteAction.icon, children: deleteAction.label }),
        unpublishAction && /* @__PURE__ */ jsxRuntime.jsx(designSystem.MenuItem, { onSelect: unpublishAction.dialog?.open, startIcon: unpublishAction.icon, children: unpublishAction.label }),
        discardAction && /* @__PURE__ */ jsxRuntime.jsx(designSystem.MenuItem, { onSelect: discardAction.dialog?.open, variant: discardAction.variant, startIcon: discardAction.icon, children: discardAction.label })
      ] })
    ] }),
    deleteAction && /* @__PURE__ */ jsxRuntime.jsx(DocumentActionConfirmDialog, { title: "Confirmation", onClose: deleteAction.dialog.close, onConfirm: deleteAction.onClick, isOpen: deleteAction.dialog.isOpen, content: deleteAction.dialog.content }, "delete"),
    unpublishAction && /* @__PURE__ */ jsxRuntime.jsx(DocumentActionConfirmDialog, { title: "Confirmation", onClose: unpublishAction.dialog.close, onConfirm: unpublishAction.onClick, isOpen: unpublishAction.dialog.isOpen, content: unpublishAction.dialog.content }, "unpublish"),
    discardAction && /* @__PURE__ */ jsxRuntime.jsx(DocumentActionConfirmDialog, { title: discardAction.dialog?.title, onClose: discardAction.dialog?.close, onConfirm: discardAction.onClick, isOpen: discardAction.dialog?.isOpen, content: discardAction.dialog?.content }, "discard")
  ] });
};
const Radios = ({ memberTypes, documentId, model }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Radio.Group, { "aria-label": "member type", value: selectedMemberType.id, onValueChange: handleGroupChange, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { tag: "label", variant: "pi", fontWeight: "bold", children: "Select type of new member" }),
      memberTypes.map((item) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Radio.Item, { value: item.id, children: item.membershipName || "Unknown membership type" }, item.id))
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, justifyContent: "center", alignItems: "center", width: "50%", children: [
      /* @__PURE__ */ jsxRuntime.jsx(ApproveButton, { documentId, model, membershipTypeId: selectedMemberType.id, membershipTypeDocumentId: selectedMemberType.documentId }),
      /* @__PURE__ */ jsxRuntime.jsx(RejectButton, { documentId, model, membershipTypeId: selectedMemberType.id, membershipTypeDocumentId: selectedMemberType.documentId })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Menu.Trigger,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, { tag: "span", children: label || "More document actions" })
        ]
      }
    ),
      ...
      actions.map((action) => {
        return /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Menu.Item,
          {
            ...
            startIcon: action.icon,
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "space-between", gap: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: 2, tag: "span", children: action.label }) })
          },
          action.id
        );
      }),
...
//# sourceMappingURL=useDeleteAction-WNd52Gyv.js.map
