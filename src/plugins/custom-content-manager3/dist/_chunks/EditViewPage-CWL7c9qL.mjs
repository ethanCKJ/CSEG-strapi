...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DGAET8RX.mjs";
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Accordion.Root, { variant: "primary", children: /* @__PURE__ */ jsxs(Accordion.Item, { value: "acc-01", children: [
      /* @__PURE__ */ jsx(Accordion.Header, { children: /* @__PURE__ */ jsx(Accordion.Trigger, { description: "Your personal information", children: "Show scheduled emails (updated after saving document)" }) }),
      /* @__PURE__ */ jsx(Accordion.Content, { children: /* @__PURE__ */ jsx(ScheduledEmails, { model, documentId }) })
    ] }) })
  ] });
};
...
//# sourceMappingURL=EditViewPage-CWL7c9qL.mjs.map
