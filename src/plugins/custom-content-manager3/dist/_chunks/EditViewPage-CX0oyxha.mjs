...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DJtRZdoe.mjs";
    ...
    try {
      for (let i = 0; i < emailTemplateName.length; i++) {
        ...
        if (res.data.data && res.data.data.template) {
          ...
          const physicalLocation = formValues.physicalLocation ?? "";
          const teamsLink = formValues.teamsLink ?? "";
          ...
          if (typeof physicalLocation === "string" && typeof teamsLink === "string") {
            ...
            if (physicalLocation && teamsLink) {
              locationFormatted = `This event will be hybrid - both in person in {`;
            }
          }
...
//# sourceMappingURL=EditViewPage-CX0oyxha.mjs.map
