...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-Czdyf92l.mjs";
          ...
          /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsx(
            Form,
            {
              ...
              validate: (values2, options) => {
                ...
                return yupSchema.validate(values2, { abortEarly: false });
              },
...
const usePublishAction = ({
  ...
  const formValues = useForm("usePublishAction", ({ values: values2 }) => values2);
...
const useUpdateAction = (activeTab, documentId, model, collectionType) => {
  ...
  const document2 = useForm("UpdateAction", ({ values: values2 }) => values2);
...
const useHandleApplicationAction = (documentId, model) => {
  ...
  const document2 = useForm("useHandleApplicationAction", ({ values: values2 }) => values2);
...
const EventActionPanel = ({
  ...
  useForm("EventActionPanelForm", ({ setValues, values: values2 }) => ({ setValues, values: values2 }));
  console.log(values);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
...
const EditViewPage = () => {
  ...
  const validateSync = (values2, options) => {
    const yupSchema = createYupSchema(schema?.attributes, components, {
      status,
      ...options
    });
    return yupSchema.validateSync(values2, { abortEarly: false });
  };
  ...
  return /* @__PURE__ */ jsxs(Main, { paddingLeft: RESPONSIVE_DEFAULT_SPACING, paddingRight: RESPONSIVE_DEFAULT_SPACING, children: [
    ...
    /* @__PURE__ */ jsx(
      Form,
      {
        ...
        validate: (values2, options) => {
          const { data: cleanedValues, removedAttributes } = handleInvisibleAttributes(values2, {
            schema,
            initialValues,
            components
          });
...
//# sourceMappingURL=EditViewPage-CBokXFOV.mjs.map
