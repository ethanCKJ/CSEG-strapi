...
const index = require("./index-DcQTP3ci.js");
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  if (isLoading) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, alignItems: "start", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: "No scheduled emails found. Make sure you selected mailing lists " }),
...
//# sourceMappingURL=EditViewPage-U6djARLj.js.map
