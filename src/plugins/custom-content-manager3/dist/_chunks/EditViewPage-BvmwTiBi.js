...
const index = require("./index-ChcW7Y2w.js");
...
const usePublishAction = ({
  ...
  const formValues = admin.useForm("usePublishAction", ({ values: values2 }) => values2);
...
const useUpdateAction = (activeTab, documentId, model, collectionType) => {
  ...
  const document2 = admin.useForm("UpdateAction", ({ values: values2 }) => values2);
...
const useHandleApplicationAction = (documentId, model) => {
  ...
  const document2 = admin.useForm("useHandleApplicationAction", ({ values: values2 }) => values2);
...
const EventActionPanel = ({
  ...
  admin.useForm("EventActionPanelForm", ({ setValues, values: values2 }) => ({ setValues, values: values2 }));
  console.log(values);
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
...
//# sourceMappingURL=EditViewPage-BvmwTiBi.js.map
