...
const ProtectedEditViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./EditViewPage-Bz14BCVp.js")).then((n) => n.EditViewPage).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListViewPage-BYqcQwzG.js")).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListTabbedPage-Dk826VUp.js")).then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await Promise.resolve().then(() => require("./layout-Cp-vA7dA.js"));
        return {
          Component: Layout
        };
      },
...
exports.index = index;
//# sourceMappingURL=index-BJXk_J6L.js.map
