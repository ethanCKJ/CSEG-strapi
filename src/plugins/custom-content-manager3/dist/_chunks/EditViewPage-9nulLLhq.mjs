...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DZK1prYa.mjs";
      ...
      for (let i = 0; i < emailTemplateName.length; i++) {
        ...
        if (res.data.data && res.data.data.template) {
          ...
          if (typeof formValues.eventType === "string" && formValues.eventType.trim() !== "") {
            ...
            if (!trimmedType.includes("other")) {
              eventTypeFormatted = trimmedType;
            }
          }
          let physicalLocation = "";
          if (typeof formValues.physicalLocation === "string" && formValues.physicalLocation.trim() !== "") {
            physicalLocation = formValues.physicalLocation.trim();
          }
          let teamsLink = "";
...
//# sourceMappingURL=EditViewPage-9nulLLhq.mjs.map
