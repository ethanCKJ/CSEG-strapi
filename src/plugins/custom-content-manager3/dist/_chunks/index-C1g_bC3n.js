...
const ProtectedEditViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./EditViewPage-BWnWt6HD.js")).then((n) => n.EditViewPage).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListViewPage-DjevNGkb.js")).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListTabbedPage-yDXEvjcl.js")).then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await Promise.resolve().then(() => require("./layout-DNe7Zbsp.js"));
        return {
          Component: Layout
        };
      },
...
exports.index = index;
//# sourceMappingURL=index-C1g_bC3n.js.map
