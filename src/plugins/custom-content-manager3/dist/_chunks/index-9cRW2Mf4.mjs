...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-CSm7HVfQ.mjs").then((n) => n.E).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-Dzhl2Xg1.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = lazy(
  () => import("./ListTabbedPage-D585rhfu.mjs").then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-Bb63ibBa.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-9cRW2Mf4.mjs.map
