...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-DrFhGQ1S.mjs";
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Button, { children: "Update Event Dates" }),
    /* @__PURE__ */ jsx(
      StandardActionPanel,
      {
        model,
...
//# sourceMappingURL=EditViewPage-DwOAky-I.mjs.map
