...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-CqwxlhlK.mjs";
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  if (isLoading) {
    ...
    return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, alignItems: "start", children: [
      /* @__PURE__ */ jsx(Typography, { children: "No scheduled emails found." }),
      /* @__PURE__ */ jsx(Button, { onClick: handleRefresh, loading: isFetching, size: "S", variant: "secondary", children: "Refresh" })
    ] });
  }
  return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, alignItems: "start", background: "neutral100", width: "100%", children: [
    /* @__PURE__ */ jsx(Button, { onClick: handleRefresh, loading: isFetching, size: "S", variant: "secondary", children: "Refresh" }),
    data.results.map((email) => /* @__PURE__ */ jsxs(Flex, { direction: "column", padding: 2, borderColor: "neutral150", borderWidth: "1px", hasRadius: true, width: "100%", alignItems: "start", children: [
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Accordion.Root, { variant: "primary", children: /* @__PURE__ */ jsxs(Accordion.Item, { value: "acc-01", children: [
      /* @__PURE__ */ jsx(Accordion.Header, { children: /* @__PURE__ */ jsx(Accordion.Trigger, { description: "Your personal information", children: "Show scheduled and sent emails (updated after saving document and refreshing page)" }) }),
...
//# sourceMappingURL=EditViewPage-CrdIdGTX.mjs.map
