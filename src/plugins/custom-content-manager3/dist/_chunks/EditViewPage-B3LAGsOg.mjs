...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-D5fwhmMK.mjs";
    ...
    try {
      for (let i = 0; i < emailTemplateName.length; i++) {
        ...
        if (res.data.data && res.data.data.template) {
          ...
          const lodashTemplate = template(textTemplate);
          const abstract2 = formValues.abstract ?? "[Please copy and paste abstract here]";
          const eventDate2 = formValues.eventDate ?? "[Please copy and paste date here]";
          const eventStartTime2 = formValues.eventStartTime ?? "[Please copy and paste start time here]";
          const eventEndTime2 = formValues.eventEndTime ?? "[Please copy and paste end time here]";
          const result = lodashTemplate({});
        } else {
...
//# sourceMappingURL=EditViewPage-B3LAGsOg.mjs.map
