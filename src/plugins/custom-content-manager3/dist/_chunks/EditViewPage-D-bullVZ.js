...
const index = require("./index-DEo3MpOC.js");
...
const EventActionPanel = ({
  ...
  admin.useForm("EventActionPanelForm", ({ setValues, values }) => ({ setValues, values }));
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
...
//# sourceMappingURL=EditViewPage-D-bullVZ.js.map
