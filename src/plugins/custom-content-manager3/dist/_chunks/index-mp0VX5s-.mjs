...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-DbRoVxDz.mjs").then((n) => n.E).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-By_tsZoh.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
...
const ProtectedListMemberApplicationPage = lazy(
  () => import("./ListTabbedPage-CMJNLrCi.mjs").then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-DHcagOXx.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-mp0VX5s-.mjs.map
