...
import { createRulesEngine, adminApi, translatedErrors, useNotification, useAPIErrorHandler, useQueryParams, getYupValidationErrors, useStrapiApp, useForm, Blocker as Blocker$1, useAuth, useRBAC, Page, createContext, Form, ConfirmDialog, DescriptionComponentRenderer, useField, useElementOnScreen, useIsDesktop, useFocusInputField, InputRenderer, BackButton, RESPONSIVE_DEFAULT_SPACING } from "@strapi/strapi/admin";
import { Status, Typography, Button, Dialog, Modal, Tabs, Flex, IconButton, TextButton, Loader, EmptyStateLayout, Box as Box$1, SingleSelect, SingleSelectOption, Popover, Field, Menu, Tooltip, useComposedRefs, VisuallyHidden, Divider, Accordion, Grid as Grid$1, Combobox, ComboboxOption, Link as Link$2, TextInput, IconButtonGroup, Radio, SimpleMenu, MenuItem, Main } from "@strapi/design-system";
import { useIntl } from "react-intl";
import { useParams, useNavigate, useLocation, useMatch } from "react-router-dom";
import { styled, css, createGlobalStyle, keyframes } from "styled-components";
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-fAan9-G_.mjs";
...
const RelationModalForm = () => {
  ...
  return /* @__PURE__ */ jsxs(DocumentRBAC, { permissions, model: currentDocumentMeta.model, children: [
    /* @__PURE__ */ jsxs(Flex, { alignItems: "flex-start", direction: "column", gap: 2, children: [
      ...
      hasDraftAndPublished ? /* @__PURE__ */ jsx(Box$1, { children: /* @__PURE__ */ jsx(DocumentStatus, { status: currentDocument.document?.status }) }) : null
    ] }),
    /* @__PURE__ */ jsx(Flex, { flex: 1, overflow: "auto", alignItems: "stretch", paddingTop: 7, children: /* @__PURE__ */ jsx(Box$1, { overflow: "auto", flex: 1, children: /* @__PURE__ */ jsx(
      FormLayout,
      {
...
const CodeEditor = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Box$1, { position: "relative", width: "100%", children: [
...
const Image = ({ attributes, children, element }) => {
  ...
  return /* @__PURE__ */ jsxs(Box$1, { ...attributes, children: [
    children,
    /* @__PURE__ */ jsx(
      ImageWrapper,
      {
...
`;
const SelectWrapper = styled(Box$1)`
...
`;
const Wrapper$1 = styled(Box$1)`
  position: ${({ $isOverDropTarget }) => $isOverDropTarget && "relative"};
`;
const DropPlaceholder = styled(Box$1)`
  position: absolute;
  right: 0;
...
const RepeatableComponent = ({
  ...
  return /* @__PURE__ */ jsxs(Box$1, { hasRadius: true, children: [
    /* @__PURE__ */ jsx(VisuallyHidden, { id: ariaDescriptionId, children: formatMessage({
...
`;
const Grid = process.env.NODE_ENV !== "test" ? styled(Box$1)`
        display: grid;
  ...
  return /* @__PURE__ */ jsxs(
    Box$1,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Box$1, { paddingTop: 2, children: /* @__PURE__ */ jsx(Accordion.Root, { defaultValue: Object.keys(dynamicComponentsByCategory)[0], children: Object.entries(dynamicComponentsByCategory).map(([category, components], index) => /* @__PURE__ */ jsx(
          ComponentCategory,
          {
            category,
            components,
...
const DynamicComponent = ({
  ...
  return /* @__PURE__ */ jsxs(ComponentContainer, { tag: "li", width: "100%", children: [
    ...
    /* @__PURE__ */ jsx(StyledBox, { ref: composedBoxRefs, hasRadius: true, children: isDragging ? /* @__PURE__ */ jsx(Preview, {}) : /* @__PURE__ */ jsx(Accordion.Root, { value: collapseToOpen, onValueChange: setCollapseToOpen, children: /* @__PURE__ */ jsxs(Accordion.Item, { value: accordionValue, children: [
      ...
      /* @__PURE__ */ jsx(Accordion.Content, { children: /* @__PURE__ */ jsx(AccordionContentRadius, { background: "neutral0", children: /* @__PURE__ */ jsx(Box$1, { paddingLeft: 6, paddingRight: 6, paddingTop: 6, paddingBottom: 6, children: /* @__PURE__ */ jsx(Grid$1.Root, { gap: 4, children: components[componentUid]?.layout?.map((row, rowInd) => {
        const visibleFields = row.filter(({ ...field }) => {
          const condition = field.attribute.conditions?.visible;
          if (condition) {
            return rulesEngine2.evaluate(condition, value);
...
const StyledBox = styled(Box$1)`
  > div:first-child {
    box-shadow: ${({ theme }) => theme.shadows.tableShadow};
  }
`;
const AccordionContentRadius = styled(Box$1)`
  border-radius: 0 0 ${({ theme }) => theme.spaces[1]} ${({ theme }) => theme.spaces[1]};
`;
const Rectangle = styled(Box$1)`
...
`;
const ComponentContainer = styled(Box$1)`
  list-style: none;
  padding: 0;
  margin: 0;
`;
    ...
    Box$1,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { direction: "column", justifyContent: "center", children: [
        /* @__PURE__ */ jsxs(Flex, { maxWidth: "35.6rem", children: [
          ...
          labelAction && /* @__PURE__ */ jsx(Box$1, { paddingLeft: 1, children: labelAction })
        ] }),
        hint && /* @__PURE__ */ jsx(Box$1, { paddingTop: 1, maxWidth: "35.6rem", children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", ellipsis: true, children: hint }) })
      ] })
    }
  ) });
};
...
const DynamicZone = ({
  ...
  return /* @__PURE__ */ jsx(DynamicZoneProvider, { isInDynamicZone: true, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
    dynamicDisplayedComponentsLength > 0 && /* @__PURE__ */ jsxs(Box$1, { children: [
      /* @__PURE__ */ jsx(
        DynamicZoneLabel,
        {
          hint,
          ...
          children: [
            /* @__PURE__ */ jsxs(FlexWrapper, { gap: 1, children: [
              ...
              /* @__PURE__ */ jsxs(Flex, { width: "100%", minWidth: 0, gap: 4, justifyContent: "space-between", children: [
                /* @__PURE__ */ jsx(Box$1, { flex: 1, minWidth: 0, paddingTop: 1, paddingBottom: 1, children: /* @__PURE__ */ jsx(RelationModalRenderer, { relation: documentMeta, children: label }) }),
                status ? /* @__PURE__ */ jsx(DocumentStatus, { status }) : null
              ] })
            ] }),
            /* @__PURE__ */ jsx(Box$1, { paddingLeft: 4, children: /* @__PURE__ */ jsx(
              IconButton,
              {
  ...
  if (isExpandMode) {
    return /* @__PURE__ */ jsx(Modal.Root, { open: isExpandMode, onOpenChange: onCollapse, children: /* @__PURE__ */ jsx(Modal.Content, { style: { maxWidth: "unset", width: "unset" }, children: /* @__PURE__ */ jsxs(Flex, { height: "90dvh", width: "90dvw", alignItems: "flex-start", children: [
      ...
      /* @__PURE__ */ jsxs(Flex, { alignItems: "start", direction: "column", flex: 1, height: "100%", width: "100%", children: [
        ...
        /* @__PURE__ */ jsx(Box$1, { position: "relative", height: "100%", width: "100%", children: /* @__PURE__ */ jsx(PreviewWysiwyg, { data: previewContent }) })
      ] })
    ] }) }) });
  }
  return /* @__PURE__ */ jsx(
...
const BoxWithBorder = styled(Box$1)`
...
const WysiwygFooter = ({ onToggleExpand }) => {
  const { formatMessage } = useIntl();
  return /* @__PURE__ */ jsx(Box$1, { padding: 2, background: "neutral100", borderRadius: `0 0 0.4rem 0.4rem`, children: /* @__PURE__ */ jsx(Flex, { justifyContent: "flex-end", alignItems: "flex-end", children: /* @__PURE__ */ jsxs(ExpandButton, { id: "expand", onClick: onToggleExpand, variant: "tertiary", size: "M", children: [
  ...
  return /* @__PURE__ */ jsx(
    Flex,
    {
      ...
      children: layout.map((panel, index) => {
        ...
        return /* @__PURE__ */ jsx(Box$1, { ...hasBackground && panelStyles, children: /* @__PURE__ */ jsx(
          Flex,
          {
            direction: "column",
            alignItems: "stretch",
  ...
  return /* @__PURE__ */ jsxs(
    Flex,
    {
      ...
      children: [
        ...
        status ? /* @__PURE__ */ jsx(Box$1, { marginTop: 1, children: /* @__PURE__ */ jsx(DocumentStatus, { status: isCloning ? "draft" : status }) }) : null
      ]
    }
  );
};
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Typography, { children: "Special actions" })
  ] });
};
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Flex, { alignItems: "center", width: "100%", gap: 8, children: [
      /* @__PURE__ */ jsxs(Flex, { gap: 2, justifyContent: "center", alignItems: "center", width: "50%", children: [
        /* @__PURE__ */ jsx(PublishButton, { documentId, activeTab: status, model, collectionType, meta, document: document2 }),
        /* @__PURE__ */ jsx(UpdateButton, { activeTab: status, documentId, model, collectionType })
      ] }),
      /* @__PURE__ */ jsxs(SimpleMenu, { label: "More actions", variant: "tertiary", children: [
        /* @__PURE__ */ jsx(MenuItem, { onSelect: deleteAction.dialog?.open, variant: deleteAction.variant, startIcon: deleteAction.icon, children: deleteAction.label }),
        unpublishAction && /* @__PURE__ */ jsx(MenuItem, { onSelect: unpublishAction.dialog?.open, startIcon: unpublishAction.icon, children: unpublishAction.label }),
        discardAction && /* @__PURE__ */ jsx(MenuItem, { onSelect: discardAction.dialog?.open, variant: discardAction.variant, startIcon: discardAction.icon, children: discardAction.label })
      ] })
    ] }),
    deleteAction && /* @__PURE__ */ jsx(DocumentActionConfirmDialog, { title: "Confirmation", onClose: deleteAction.dialog.close, onConfirm: deleteAction.onClick, isOpen: deleteAction.dialog.isOpen, content: deleteAction.dialog.content }, "delete"),
    unpublishAction && /* @__PURE__ */ jsx(DocumentActionConfirmDialog, { title: "Confirmation", onClose: unpublishAction.dialog.close, onConfirm: unpublishAction.onClick, isOpen: unpublishAction.dialog.isOpen, content: unpublishAction.dialog.content }, "unpublish"),
    discardAction && /* @__PURE__ */ jsx(DocumentActionConfirmDialog, { title: discardAction.dialog?.title, onClose: discardAction.dialog?.close, onConfirm: discardAction.onClick, isOpen: discardAction.dialog?.isOpen, content: discardAction.dialog?.content }, "discard")
  ] });
};
const Radios = ({ memberTypes, documentId, model }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Radio.Group, { "aria-label": "member type", value: selectedMemberType.id, onValueChange: handleGroupChange, children: [
      /* @__PURE__ */ jsx(Typography, { tag: "label", variant: "pi", fontWeight: "bold", children: "Select type of new member" }),
      memberTypes.map((item) => /* @__PURE__ */ jsx(Radio.Item, { value: item.id, children: item.membershipName || "Unknown membership type" }, item.id))
    ] }),
    /* @__PURE__ */ jsxs(Flex, { gap: 2, justifyContent: "center", alignItems: "center", width: "50%", children: [
      /* @__PURE__ */ jsx(ApproveButton, { documentId, model, membershipTypeId: selectedMemberType.id, membershipTypeDocumentId: selectedMemberType.documentId }),
      /* @__PURE__ */ jsx(RejectButton, { documentId, model, membershipTypeId: selectedMemberType.id, membershipTypeDocumentId: selectedMemberType.documentId })
    ] }),
    /* @__PURE__ */ jsx(Flex, { alignItems: "center", width: "100%", gap: 8 })
  ] });
};
const MemberApplicationActionPanel = ({ documentId, model, document: document2 }) => {
            ...
            /* @__PURE__ */ jsxs(
              Grid$1.Root,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Grid$1.Item, { col: 9, xs: 12, direction: "column", alignItems: "stretch" })
                ]
              }
            ),
            /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(CustomPanel, {}) })
          ] }),
...
//# sourceMappingURL=EditViewPage-DML941oX.mjs.map
