...
import { I as InjectionZone, V as ViewSettingsMenu, F as FiltersImpl, g as getDisplayName, C as CellContent, T as TableActions } from "./Filters-Bf0WTf2l.mjs";
import { u as useDoc, a as useDocumentLayout, b as usePrev, c as buildValidParams, d as useGetAllDocumentsQuery, D as DocumentStatus, e as convertListLayoutToFieldLayouts } from "./EditViewPage-q78SlcYa.mjs";
import { g as getTranslation } from "./index-C8UEbF79.mjs";
const HOOKS = {
  /**
...
const ListViewPage = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Page.Main, { children: [
    /* @__PURE__ */ jsx(Page.Title, { children: `${contentTypeTitle} I am a dummy change` }),
