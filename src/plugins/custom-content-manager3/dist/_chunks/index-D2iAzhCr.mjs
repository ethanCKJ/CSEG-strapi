...
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-BbhsYqEz.mjs").then((n) => n.L).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
const CollectionTypePages = () => {
  ...
  return /* @__PURE__ */ jsx(ProtectedListViewPage, {});
};
...
const index = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-D_YKTb58.mjs");
        return App;
      }
    });
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-U-QzfEay.mjs");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=index-D2iAzhCr.mjs.map
