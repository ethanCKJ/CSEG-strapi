...
const index = require("./index-dJwyCRl7.js");
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  if (isLoading) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, alignItems: "start", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: "No scheduled emails found." }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, alignItems: "start", background: "neutral100", width: "100%", children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleRefresh, loading: isFetching, size: "S", variant: "secondary", children: "Refresh" }),
    data.results.map((email) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", padding: 2, borderColor: "neutral150", borderWidth: "1px", hasRadius: true, width: "100%", alignItems: "start", children: [
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Root, { variant: "primary", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion.Item, { value: "acc-01", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Trigger, { description: "Your personal information", children: "Show scheduled and sent emails (updated after saving document and refreshing page)" }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Content, { children: /* @__PURE__ */ jsxRuntime.jsx(ScheduledEmails, { model, documentId }) })
    ] }) })
  ] });
};
...
//# sourceMappingURL=EditViewPage-DQKiLuVx.js.map
