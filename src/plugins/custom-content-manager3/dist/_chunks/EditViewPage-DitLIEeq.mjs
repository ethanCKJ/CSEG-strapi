...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-Q8k8xilP.mjs";
...
const EventActionPanel = ({
  ...
  useForm("EventActionPanelForm", ({ setValues }) => ({ setValues, values }));
  console.log(values);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
...
//# sourceMappingURL=EditViewPage-DitLIEeq.mjs.map
