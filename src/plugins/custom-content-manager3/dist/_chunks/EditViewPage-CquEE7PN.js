...
const index = require("./index-Dl5Mu_G8.js");
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  if (isLoading) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, alignItems: "start", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: "No scheduled emails found. Make sure you selected mailing lists in the 'Member types the event is open to' or  " }),
...
//# sourceMappingURL=EditViewPage-CquEE7PN.js.map
