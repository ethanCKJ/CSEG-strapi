...
const index = require("./index-AQkppjOe.js");
...
const EventActionPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    formValues.showDisableToggles && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: handleEmailTemplates, loading: loadingTemplates, children: "Generate Email Templates" }),
    /* @__PURE__ */ jsxRuntime.jsx(
      StandardActionPanel,
      {
        model,
...
//# sourceMappingURL=EditViewPage-Y_zcDDSY.js.map
