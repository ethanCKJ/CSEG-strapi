...
const models = "Types de Collection";
const pageNotFound = "Page non trouvée";
const fr = {
  ...
  "containers.EditView.saveHint": "Ctrl / Cmd + Entrée pour {action}",
  ...
  "containers.list.items": "{number} {number, plural, =0 {éléments} one {élément} other {éléments}}",
