...
const ProtectedEditViewPage = lazy(
  () => import("./EditViewPage-q78SlcYa.mjs").then((n) => n.E).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = lazy(
  () => import("./ListViewPage-D4xnEgkJ.mjs").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
const ProtectedListMemberApplicationPage = lazy(
  () => import("./ListTabbedPage-D-Dpb2QA.mjs").then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
const ProtectedListContactPage = lazy(
  () => import("./ListTabbedPage-D-Dpb2QA.mjs").then((mod) => ({ default: mod.ProtectedListContactPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-DqApSebJ.mjs");
        return {
          Component: Layout
        };
      },
