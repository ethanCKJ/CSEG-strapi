...
const index = require("./index-DuRvZP-W.js");
...
const ScheduledEmails = ({ model, documentId }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", gap: 2, children: data.results.map((email) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", padding: 2, borderColor: "neutral150", borderWidth: "1px", hasRadius: true, alignItems: "start", background: "neutral100", children: [
...
//# sourceMappingURL=EditViewPage-DQ-fGQyN.js.map
