...
import { S as SINGLE_TYPES, g as getTranslation, C as COLLECTION_TYPES, a as CLONE_PATH, L as LIST_PATH, M as MEMBER_APPLICATION_MODEL, A as APPLICATION_STATUS, E as EVENT_MODEL } from "./index-BZ__28VD.mjs";
...
const EventActionPanel = ({
  ...
  const form = useForm("EventActionPanelForm", ({ setValues }) => ({ setValues }));
  console.log(form);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
...
//# sourceMappingURL=EditViewPage-BGhDShkP.mjs.map
