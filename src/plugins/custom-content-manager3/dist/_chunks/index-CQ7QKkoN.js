...
const ProtectedEditViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./EditViewPage-B36HahLm.js")).then((n) => n.EditViewPage).then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
const ProtectedListViewPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListViewPage-C59ibSpe.js")).then((mod) => ({ default: mod.ProtectedListViewPage }))
);
const ProtectedListMemberApplicationPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListTabbedPage-y2UlERQK.js")).then((mod) => ({ default: mod.ProtectedListMemberApplicationPage }))
);
const ProtectedListContactPage = React.lazy(
  () => Promise.resolve().then(() => require("./ListTabbedPage-y2UlERQK.js")).then((mod) => ({ default: mod.ProtectedListContactPage }))
);
...
const index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await Promise.resolve().then(() => require("./layout-BrigzB-K.js"));
        return {
          Component: Layout
        };
      },
